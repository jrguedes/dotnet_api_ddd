...
namespace Data.Migrations
{
    ...
    [Migration("20211102145557_UF_Municipio_Enderecos")]
    partial class UF_Municipio_Enderecos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.Entities.Municipio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("API.Domain.Entities.UF", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5680),
                            Nome = "Acre",
                            Sigla = "AC"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5690),
                            Nome = "Alagoas",
                            Sigla = "AL"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5700),
                            Nome = "Amazonas",
                            Sigla = "AM"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5710),
                            Nome = "Ceará",
                            Sigla = "CE"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5720),
                            Nome = "Minas Gerais",
                            Sigla = "MG"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5730),
                            Nome = "Paraíba",
                            Sigla = "PB"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5740),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 2, 14, 55, 57, 19, DateTimeKind.Utc).AddTicks(5750),
                            Nome = "Santa Catarina",
                            Sigla = "SC"
                        },
                        new
            ...
            modelBuilder.Entity("API.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8abdee27-250c-4e19-809a-cc25ed213fcb"),
                            CreatedAt = new DateTime(2021, 11, 2, 11, 55, 56, 990, DateTimeKind.Local).AddTicks(1010),
                            Email = "gerente@gmail.com",
                            Name = "Gerente",
                            Role = "Manager",
                            UpdatedAt = new DateTime(2021, 11, 2, 11, 55, 57, 16, DateTimeKind.Local).AddTicks(1950)
                        });
                });

            modelBuilder.Entity("API.Domain.Entities.Endereco", b =>
                {
                    b.HasOne("API.Domain.Entities.Municipio", "Municipio")
                        .WithMany("Enderecos")
            ...
            modelBuilder.Entity("API.Domain.Entities.Municipio", b =>
                {
                    b.HasOne("API.Domain.Entities.UF", "UF")
                        .WithMany("Municipios")
                        .HasForeignKey("UFId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
